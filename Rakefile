...
desc 'Generate documentation for the orders_tracker extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'OrdersTrackerExtension'
...
desc 'Test the orders_tracker extension.'
...
namespace :test do
  desc 'Functional test the orders_tracker extension.'
  ...
  desc 'Unit test the orders_tracker extension.'
